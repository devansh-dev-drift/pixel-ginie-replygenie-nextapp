...
const Sidebar: FC<ISidebarProps> = (props) => {
    ...
    return (
        <>
            ...
            <aside className='h-screen bg-[#151E36] z-20 min-w-[326px] pl-10 pr-5 hidden lg:flex border-r-[0.5px] border-[#2c344a]'>
                    ...
                    <div className='flex-1 relative'>
                        ...
                        <div className='bottom-0 absolute w-full border-t-[0.5px] py-5 border-[#D2C4EB] flex justify-between'>
                            <div className='flex gap-4 items-center'>
                                ...
                                <p className='font-medium font-lato text-xl text-white'>
                        ...
                        {menuTrigger && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className='font-medium cursor-pointer text-sm text-gray-600' onClick={logout}>Log Out</p>
                                </button>
                            </div>
                        )}
                    </div>
