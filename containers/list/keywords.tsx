...
import { getProjectDetails, getKeywords, createKeyword, keywordDelete } from '@/services/api';
...
const Keywords: FC<IKeywordsProps> = (props: any) => {
    ...
    const [projectId, sethandleProject] = useState('')
    ...
    const handleCreate = async () => {
        ...
        const create = await createKeyword(id, keywords, mentions, replies);
        init();
    }

    const handleDelete = async (id: string) => {
        const data = await keywordDelete(id);
        init();
    }
                        ...
                        <tbody>
                            ...
                            <tr className="border-t-[0.5px] border-[#2c344a] text-xl font-normal ">
                                ...
                                <td className="border-[#2c344a] text-center">
                                    <button onClick={() => handleCreate()} className='bg-[#108bf6] font-lato text-[16px] min-w-[219px] max-w-[219px] w-full py-2 rounded-lg text-white font-bold'>Create</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
